    ...
    (mealDetails) => `
        <div class="col-sm-6 col-xl-4 item">
         ...
         <div class="col-sm-6 col-xl-4 item">
            <div class="card">
                <div class="card-thumbnail">
                    <div class="black-overlay">
                    	<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSL64QU2oeAYPk289-33qxDbTyU6m0R6o13TQ&s" alt="" class="card-img-top">
                    </div>
                    <button class="btn btn-warning add-to-cart-button" data-product-id="${mealDetails.id}" data-product-name="${mealDetails.name}" data-product-price="10.20">+ Add to Cart</button>
            	</div>
            	<div class="card-body">
        ...
        <div class="col-sm-6 col-xl-4 item">
            <div class="card">
                <div class="card-thumbnail">
                    <div class="black-overlay">
                    	<img src="https://miro.medium.com/v2/resize:fit:736/1*i_wlSPASiAybrYVW5RIo2g.jpeg" alt="" class="card-img-top">
                    </div>
                    <button class="btn btn-warning add-to-cart-button" data-product-id="${mealDetails.id}" data-product-name="${mealDetails.name}" data-product-price="10.20">+ Add to Cart</button>
            	</div>
            	<div class="card-body">
